...
import avuilder4j.entities.game.base.TypeBlockBase;

/**
 * Immutable Avorion block type reference.
 */
public class TypeBlockFunctional extends TypeBlockBase {
	 ...
	 */
	public TypeBlockFunctional(int index, String name, Double density, Double durability, Double creditCost, Double materialCost,
