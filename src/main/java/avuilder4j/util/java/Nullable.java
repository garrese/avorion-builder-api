...
public class Nullable {
	...
	public static Double sum(Number n1, Number n2, Double defaultValue) {
		...
		return sumSupplier(n1D, n2D, () -> n1D + n2D, defaultValue);
	}
	...
	public static <T> T sumSupplier(T sum1, T sum2, Supplier<T> supplier) {
		return sumSupplier(sum1, sum2, supplier, null);
	}

	public static <T> T sumSupplier(T sum1, T sum2, Supplier<T> supplier, T defaultValue) {
