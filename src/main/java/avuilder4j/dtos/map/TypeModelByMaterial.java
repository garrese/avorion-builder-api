...
public class TypeModelByMaterial implements Indexable {

	protected TypeByMaterialMapIndex mapIndex;
	protected Double creditCostMod;

	public TypeModelByMaterial(TypeByMaterialMapIndex mapIndex, Double creditCostMod) {
	...
	@Override
	public TypeByMaterialMapIndex getMapIndex() { return mapIndex; }

	public static class TypeByMaterialMapIndex extends MapIndexAbstract {

		protected Integer typeModelIndex;
		protected Integer materialIndex;

		public TypeByMaterialMapIndex(Integer typeModelIndex, Integer materialIndex) {
		...
		public String toString() {
			...
			builder.append("MapIndex [typeModelIndex=");
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			TypeByMaterialMapIndex other = (TypeByMaterialMapIndex) obj;
