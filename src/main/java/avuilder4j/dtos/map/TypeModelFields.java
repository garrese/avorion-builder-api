...
public abstract class TypeModelFields implements Indexable {
	...
	@Override
	public MapIndexAbstract getMapIndex() { return index; }

	public MapIndex<Integer> getIndex() { return index; }
